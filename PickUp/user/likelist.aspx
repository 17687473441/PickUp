<%@ Page Language="C#" AutoEventWireup="true" CodeFile="likelist.aspx.cs" Inherits="queryPost" %>
    ...
    <form id="form1" runat="server" >
       <%-- <asp:ScriptManager ID="ScriptManager1" runat="server"></asp:ScriptManager>
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>--%>
                <div class="post">
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString='<%$ ConnectionStrings:connStr %>' SelectCommand="SELECT post.postid, users.pic, users.othername,givelike.userid, post.sendtime, post.text, post.imgpath, post.pd, COUNT(givelike.postid) AS count FROM post LEFT OUTER JOIN users ON users.phone = post.userid LEFT OUTER JOIN givelike ON givelike.postid = post.postid GROUP BY post.postid, users.pic, users.othername,givelike.userid, post.sendtime, post.text, post.imgpath, post.pd ORDER BY post.sendtime DESC"></asp:SqlDataSource>
                    <br />
                            ...
                            <div class="row item_msg" style="width: 450px;">
                                <div class="col-sm-12 col-xs-12 message" style="border-bottom: 1px solid #e2e2e2">
                                    ...
                                    <div class="icon-box">
                                        ...
                                        <a href='detailPost.aspx?postid=<%#Eval("postid")%>'><span class="icon iconfont icon-pinglun1"><span></span></span></a>
